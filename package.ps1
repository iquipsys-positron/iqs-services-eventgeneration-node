...
try {
    ...
    #$postParams = @{ state=@{ org_id="123"; object_id="123";time=$(Get-Date) } }
    #Invoke-WebRequest -Uri "http://$($dockerMachineIp):8080/v1/event_generation/generate_events_for_state" -Method POST -Body $postParams
