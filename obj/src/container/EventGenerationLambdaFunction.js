...
class EventGenerationLambdaFunction extends pip_services3_aws_node_1.CommandableLambdaFunction {
    constructor() {
        super("event_generation", "Event generation function");
        this._dependencyResolver.put('controller', new pip_services3_commons_node_1.Descriptor('iqs-services-eventgeneration', 'controller', 'default', '*', '*'));
...
exports.EventGenerationLambdaFunction = EventGenerationLambdaFunction;
exports.handler = new EventGenerationLambdaFunction().getHandler();
//# sourceMappingURL=EventGenerationLambdaFunction.js.map